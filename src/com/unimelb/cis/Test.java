...
public class Test {
    ...
    public static void testZRtree(String s) {
        ...
        System.out.println("knn query:" + zRtree.knnQuery(new Point(0.5f, 0.5f), 100));
    }
    ...
    public static void testHRtree(String s) {
        ...
        System.out.println("knn query:" + hRtree.knnQuery(new Point(0.5f, 0.5f), 100));
    }
    ...
    public static void testPRegression(String s) {
        ...
        System.out.println("knn query:" + PRegression.knnQuery(new Point(0.5f, 0.5f), 100));
    }
...
//        System.out.println("window query:" + Pclassification.windowQuery(new Mbr(0.5f, 0.5f, 0.6f, 0.6f)));
        System.out.println("knn query:" + Pclassification.knnQuery(new Point(0.5f, 0.5f), 100));
    }
    ...
    public static void testRRegression(String s) {
        ...
        System.out.println("knn query:" + RRegression.knnQuery(new Point(0.5f, 0.5f), 100));
    }
    ...
    public static void testRclassification(String s) {
        ...
        System.out.println("knn query:" + Rclassification.knnQuery(new Point(0.5f, 0.5f), 100));
    }
