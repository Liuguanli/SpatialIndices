package com.unimelb.cis.structures.peanotree;

import com.unimelb.cis.curve.PeanoCurve;
...
public class PeanoRtree extends RLRtree {

    public PeanoRtree(int pagesize) {
        super(pagesize);
    }
    ...
    public ExpReturn buildRtree(List<Point> points) {
        ...
        points = PeanoCurve.peanoCurve(points);
...
//            points.add(point);
    ...
    public ExpReturn insert(List<Point> points) {
        ...
        points.forEach(point -> {
            ...
            int pos = binarySearch(curveValues, PeanoCurve.getPeanoValue(indexOrder));
