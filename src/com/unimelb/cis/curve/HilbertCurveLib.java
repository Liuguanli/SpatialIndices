...
public final class HilbertCurveLib {
    ...
    private HilbertCurveLib(int bits, int dimensions) {
        this.bits = bits;
    ...
    /**
     * Builds a {@link HilbertCurveLib} instance.
     */
    public static final class Builder {
        ...
        public HilbertCurveLib dimensions(int dimensions) {
            return new HilbertCurveLib(bits, dimensions);
        }
    }
